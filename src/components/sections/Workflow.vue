<template>
  <section
    id="workflow"
    class="flex flex-col items-center gap-12 py-20 border-t border-black/5 max-w-4xl mx-auto w-full"
  >
    <div class="text-center w-full">
      <h2
        class="text-3xl sm:text-4xl lg:text-5xl font-bold font-header tracking-tight mb-4 text-brand-dark"
      >
        Simple, automated execution.
      </h2>
      <p class="text-base text-brand-slate leading-relaxed">
        Three simple stages to unlock collective organization intelligence.
      </p>
    </div>

    <div
      class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full max-w-5xl items-center"
    >
      <div class="flex flex-col gap-6 w-full">
        <div
          ...
          :class="{
            'bg-white border-primary/25 shadow-glass scale-[1.02]':
        ...
        >
          <div class="flex items-center gap-4 mb-3">
            <span
              ...
              :class="{
                'bg-grad-primary border-transparent text-white shadow-[0_4px_10px_rgba(75,104,255,0.15)]':
                  currentWorkflowStep === index,
              }"
            >
              0{{ index + 1 }}
            ...
            <h4
              class="text-base sm:text-lg font-bold font-header text-brand-dark"
            >
              {{ step.title }}
            </h4>
          </div>
          <p
            ...
            :class="{
              'text-brand-dark font-medium': currentWorkflowStep === index,
            }"
          >
            {{ step.desc }}
          </p>
      ...
      <div
        class="flex justify-center items-center relative h-[300px] sm:h-[400px] w-full"
      >
        <img
          src="../../assets/Workflow Visualization.png"
          alt="Workflow Visualization"
          class="h-full w-auto object-contain filter drop-shadow-[0_4px_25px_rgba(31,38,135,0.06)]"
        />
      </div>
    </div>
  </section>
